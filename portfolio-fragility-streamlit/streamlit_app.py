...
with overview_tab:
    ...
    with left:
        st.plotly_chart(fan_chart(result.path_percentiles), width="stretch")
    with right:
...
with liquidity_tab:
    ...
    st.plotly_chart(liquidity_figure, width="stretch")
    ...
    st.plotly_chart(cascade_figure, width="stretch")
    st.dataframe(
...
with stress_tab:
    ...
    st.plotly_chart(stress_plot, width="stretch")
    st.dataframe(
...
with simulation_tab:
    st.plotly_chart(terminal_chart(result, config), width="stretch")
